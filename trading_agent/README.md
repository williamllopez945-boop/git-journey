...
procedure documented in `PLAYBOOK.md`'s "VOLTRAP" section —
deliberately kept separate from `RISK_LIMITS`/`WATCHLIST` above (own
`VOLTRAP_RISK_LIMITS`/`VOLTRAP_WATCHLIST`/`VOLTRAP_AUTO_EXECUTE` in
